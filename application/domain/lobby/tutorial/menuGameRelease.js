({
  ...
  steps: {
    release: {
      ...
      `,
      actions: { before: async ({ $root, utils }) => await utils.transferToGameTypeBlock({ $root, utils }) },
      buttons: [
    ...
    config: {
      ...
      `,
      actions: { before: async ({ $root, utils }) => await utils.transferToConfigBlock({ $root, utils }) },
    ...
    time: {
      ...
      `,
      actions: { before: async ({ $root, utils }) => await utils.transferToSettingsBlock({ $root, utils }) },
